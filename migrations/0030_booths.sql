...
-- 604.3 sqm of stand space, Rs 1,86,90,000 ex-GST if every stand sells at list price.
...
INSERT OR IGNORE INTO booths
  ...
  (1, '19',   'explorer',    'Explorer Booth',    '2m x 2m',     4,    129000,  NULL,               0.3375,  0.54326, 0.02687, 0.02854, 19),
  (1, '20',   'explorer',    'Explorer Booth',    '2m x 2m',     4,    129000,  NULL,               0.3375,  0.51472, 0.02687, 0.02854, 20),
  (1, '21',   'explorer',    'Explorer Booth',    '2m x 2m',     4,    129000,  NULL,               0.3375,  0.48617, 0.02687, 0.02854, 21),
  (1, '22',   'explorer',    'Explorer Booth',    '2m x 2m',     4,    129000,  NULL,               0.3375,  0.45763, 0.02687, 0.02854, 22),
  (1, '23',   'explorer',    'Explorer Booth',    '2m x 2m',     4,    129000,  NULL,               0.3375,  0.42909, 0.02687, 0.02854, 23),
  (1, '24',   'explorer',    'Explorer Booth',    '2m x 2m',     4,    129000,  NULL,               0.3375,  0.40055, 0.02687, 0.02854, 24),
  (1, '25',   'explorer',    'Explorer Booth',    '2m x 2m',     4,    129000,  NULL,               0.3375,  0.37201, 0.02687, 0.02854, 25),
  (1, '26',   'explorer',    'Explorer Booth',    '2m x 2m',     4,    129000,  NULL,               0.3375,  0.34347, 0.02687, 0.02854, 26),
  ...
  (1, '29',   'explorer',    'Explorer Booth',    '2m x 2m',     4,    129000,  NULL,               0.3075,  0.24968, 0.02656, 0.02846, 29),
  (1, '30',   'explorer',    'Explorer Booth',    '2m x 2m',     4,    129000,  NULL,               0.33406, 0.24968, 0.02656, 0.02846, 30),
  ...
  (1, '35',   'explorer',    'Explorer Booth',    '2m x 2m',     4,    129000,  NULL,               0.33406, 0.22122, 0.02656, 0.02846, 35),
  (1, '36',   'explorer',    'Explorer Booth',    '2m x 2m',     4,    129000,  NULL,               0.3075,  0.22122, 0.02656, 0.02846, 36),
  (1, '37',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.31,    0.16559, 0.02031, 0.02135, 37),
  (1, '38',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.33031, 0.16559, 0.02031, 0.02135, 38),
  (1, '39',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.35063, 0.16559, 0.02031, 0.02135, 39),
  (1, '40',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.37094, 0.16559, 0.02031, 0.02135, 40),
  (1, '41',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.41187, 0.16559, 0.02042, 0.02135, 41),
  (1, '42',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.43229, 0.16559, 0.02042, 0.02135, 42),
  (1, '43',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.45271, 0.16559, 0.02042, 0.02135, 43),
  (1, '44',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.45271, 0.14424, 0.02042, 0.02135, 44),
  (1, '45',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.43229, 0.14424, 0.02042, 0.02135, 45),
  (1, '46',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.41187, 0.14424, 0.02042, 0.02135, 46),
  (1, '47',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.37094, 0.14424, 0.02031, 0.02135, 47),
  (1, '48',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.35063, 0.14424, 0.02031, 0.02135, 48),
  (1, '49',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.33031, 0.14424, 0.02031, 0.02135, 49),
  (1, '50',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.31,    0.14424, 0.02031, 0.02135, 50),
  ...
  (1, '54',   'explorer',    'Explorer Booth',    '2m x 2m',     4,    129000,  NULL,               0.47125, 0.06404, 0.04063, 0.03493, 54),
  ...
  (1, '62',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.72437, 0.40039, 0.01844, 0.02377, 62),
  (1, '63',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.72437, 0.42416, 0.01844, 0.02377, 63),
  (1, '64',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.72437, 0.44793, 0.01844, 0.02377, 64),
  (1, '65',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.72437, 0.4717,  0.01844, 0.02377, 65),
  (1, '66',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.725,   0.51035, 0.01812, 0.02361, 66),
  (1, '67',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.725,   0.53396, 0.01812, 0.02361, 67),
  (1, '68',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.725,   0.55757, 0.01812, 0.02361, 68),
  (1, '69',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.725,   0.58118, 0.01812, 0.02361, 69),
  (1, '70',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.72562, 0.61708, 0.01812, 0.02361, 70),
  (1, '71',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.72562, 0.64069, 0.01812, 0.02361, 71),
  (1, '72',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.74375, 0.64069, 0.01812, 0.02361, 72),
  (1, '73',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.74375, 0.61708, 0.01812, 0.02361, 73),
  (1, '74',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.74313, 0.58118, 0.01812, 0.02361, 74),
  (1, '75',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.74313, 0.55757, 0.01812, 0.02361, 75),
  (1, '76',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.74313, 0.53396, 0.01812, 0.02361, 76),
  (1, '77',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.74313, 0.51035, 0.01812, 0.02361, 77),
  (1, '78',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.74281, 0.4717,  0.01844, 0.02377, 78),
  (1, '79',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.74281, 0.44793, 0.01844, 0.02377, 79),
  (1, '80',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.74281, 0.42416, 0.01844, 0.02377, 80),
  (1, '81',   'pod',         'Startup Pod',       '1.5m x 1.5m', 2.25, 48000,   'Startup Pavilion', 0.74281, 0.40039, 0.01844, 0.02377, 81),
  ...
  (1, '84',   'explorer',    'Explorer Booth',    '2m x 2m',     4,    129000,  NULL,               0.81688, 0.61578, 0.02719, 0.02781, 84),
  (1, '85',   'explorer',    'Explorer Booth',    '2m x 2m',     4,    129000,  NULL,               0.84406, 0.61578, 0.02719, 0.02781, 85),
...
-- thing.
--
-- 18690000 is the full sellable value of the hall: all 93 stands at list, ex-GST
-- (Rs 1,86,90,000 -- of which Rs 6,45,000 rests on the UNCONFIRMED premium
...
VALUES ('booth_revenue_target_inr', '18690000');
