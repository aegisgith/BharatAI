...
<body style="margin:0;padding:0;background:#f5f5f5;font-family:Arial,sans-serif;">
  <div style="max-width:600px;margin:20px auto;background:white;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.1);">
    <div style="background:linear-gradient(135deg,#1e1b4b,#312e81);padding:24px 32px;text-align:center;">
      ...
      <p style="color:#c4b5fd;margin:6px 0 0;font-size:13px;">16th Bharat AI Innovation • 10-11 Dec 2026</p>
    </div>
  ...
  <div class="max-w-md w-full text-center">
    ...
    <div class="bg-white/5 backdrop-blur-xl border ${cfg.border} rounded-3xl p-8 shadow-2xl">
      ...
      <div class="bg-white/5 rounded-xl p-4 mb-6 text-left">
        ...
        <p class="text-gray-400 text-xs mt-1"><i class="fas fa-calendar-alt mr-1"></i>10-11 Dec 2026 &bull; <i class="fas fa-map-marker-alt ml-1 mr-1"></i>World Trade Center, Mumbai</p>
      </div>
    ...
    <p class="text-xs text-gray-600 mt-6">Bharat AI Innovation 2026 &bull; World Trade Center, Mumbai &bull; 10-11 Dec 2026</p>
  </div>
</body></html>`)
})
...
<body style="margin:0;padding:0;background:#f4f4f5;font-family:Arial,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:20px;">
    ...
    <div style="background:linear-gradient(135deg,#1a1a2e 0%,#16213e 50%,#0f3460 100%);border-radius:16px;padding:32px 24px;text-align:center;color:white;">
      ...
      <p style="margin:0;opacity:0.8;font-size:14px;">10-11 Dec 2026 &bull; World Trade Center, Mumbai</p>
    </div>
    <!-- Main Content -->
    <div style="background:white;border-radius:16px;padding:30px;margin-top:16px;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
      ...
      <div style="background:#f8f9fa;border-left:4px solid #1a1a2e;border-radius:0 8px 8px 0;padding:16px 20px;margin:0 0 20px;">
        ...
        <p style="color:#555;line-height:1.6;margin:0;font-size:14px;">
          <strong>Date:</strong> 10-11 Dec 2026<br>
      ...
      <div style="background:linear-gradient(135deg,#fef9e7,#fdf2d6);border:1px solid #f0d48a;border-radius:12px;padding:24px;margin:20px 0;text-align:center;">
        ...
        <p style="color:#555;line-height:1.6;margin:0 0 18px;font-size:14px;">
          Will you be attending the event on <strong>10-11 Dec 2026</strong>?
        </p>
    ...
    <p style="text-align:center;color:#999;font-size:12px;margin-top:8px;">
      Bharat AI Innovation Conference & Exhibition 2026 &bull; World Trade Center, Mumbai &bull; 10-11 Dec 2026
    </p>
  </div>
</body>
</html>`
...
<body style="margin:0;padding:0;background:#f4f4f5;font-family:Arial,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:20px;">
    ...
    <div style="background:linear-gradient(135deg,#1a1a2e 0%,#16213e 50%,#0f3460 100%);border-radius:16px;padding:32px 24px;text-align:center;color:white;">
      ...
      <p style="margin:0;opacity:0.8;font-size:14px;">Bharat AI Innovation Conference & Exhibition 2026 &bull; 10-11 Dec 2026</p>
    </div>
    <!-- Main Content -->
    <div style="background:white;border-radius:16px;padding:30px;margin-top:16px;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
      <h2 style="margin:0 0 16px;color:#1a1a2e;font-size:22px;">Dear ${attendee.name},</h2>
      <p style="color:#555;line-height:1.7;margin:0 0 16px;">
        We are truly grateful for your presence at the <strong>Bharat AI Innovation Conference & Exhibition 2026</strong> ceremony held on <strong>10-11 Dec 2026</strong> at <strong>World Trade Center Mumbai, Mumbai</strong>. Your participation and support played a vital role in making this event a resounding success.
      </p>
    ...
    <p style="text-align:center;color:#999;font-size:12px;margin-top:8px;">
      Bharat AI Innovation Conference & Exhibition 2026 &bull; World Trade Center Mumbai, Mumbai &bull; 10-11 Dec 2026
    </p>
  </div>
</body>
</html>`
...
<head>
  ...
  <meta name="description" content="${title} for Bharat AI Innovation 2026 - India's Largest AI Conference & Exhibition, 10-11 Dec 2026, WTC Mumbai">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
      ...
      <div>
        ...
        <ul class="space-y-2 text-xs text-gray-400">
          <li><i class="fas fa-calendar mr-2 text-primary-400"></i>10-11 Dec 2026</li>
...
<main class="max-w-7xl mx-auto px-4 py-8">
  ...
  <div class="max-w-2xl mx-auto mt-6">
    <div class="glass rounded-xl p-4 flex flex-wrap items-center justify-center gap-4 text-xs text-gray-400">
      ...
      <span><i class="fas fa-calendar text-primary-400 mr-1.5"></i>10-11 Dec 2026</span>
    </div>
  </div>
</main>
...
<main class="max-w-7xl mx-auto px-4 py-8">
  ...
  <div class="text-center mb-8">
    ...
    <p class="text-gray-400 max-w-2xl mx-auto">Join India's largest AI conference at World Trade Center, Mumbai on 10-11 Dec 2026. Get your free Visitor Pass or upgrade to a premium pass.</p>
  </div>
...
<main class="max-w-6xl mx-auto px-4 py-8">
  ...
  <div class="text-center mb-8">
    ...
    <p class="text-gray-400 max-w-2xl mx-auto">Showcase your AI products & solutions at India's largest AI expo — World Trade Center, Mumbai | 10-11 Dec 2026</p>
  </div>
  ...
  <div class="max-w-6xl mx-auto mt-6">
    <div class="glass rounded-xl p-4 flex flex-wrap items-center justify-center gap-4 text-xs text-gray-400">
      ...
      <span><i class="fas fa-calendar text-amber-400 mr-1.5"></i>10-11 Dec 2026</span>
    </div>
  </div>
</main>
    ...
    <main id="content" class="hidden pb-24 md:pt-16 md:pb-8">
          ...
          <div class="glass rounded-2xl p-6 border border-amber-500/20" id="rsvp-card">
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-xs text-gray-400 mb-4">Will you be attending <strong class="text-white">Bharat AI Innovation 2026</strong> on <strong class="text-white">10-11 Dec 2026</strong> at World Trade Center, Mumbai?</p>
        ...
        <div class="max-w-7xl mx-auto px-4 py-6" id="quick-visitor-reg-section">
          <div class="glass rounded-2xl p-6 md:p-8 border border-green-500/20 glow-accent" id="quick-visitor-reg-card">
            ...
            <div class="mt-4 pt-4 border-t border-white/5 flex flex-wrap gap-4 items-center justify-center text-xs text-gray-500">
              ...
              <span><i class="fas fa-calendar text-green-500 mr-1"></i>10-11 Dec 2026</span>
      ...
      <div id="tab-schedule" class="tab-content hidden">
        <div class="max-w-7xl mx-auto px-4 py-6">
          ...
          <p class="text-gray-400 text-sm mb-5">10-11 Dec 2026 · World Trade Center, Mumbai</p>
  ...
  <script>
    ...
    async function loadSchedule() {
      ...
      try {
        ...
        // ── Day selector ──
        const days = [{ val:'2026-12-10', label:'Day 1 · 10 Dec 2026' },{ val:'2026-12-11', label:'Day 2 · 11 Dec 2026' }];
    ...
    async function loadStartupPitch() {
      ...
      const html = \`
        <div class="text-center mb-8">
          ...
          <p class="text-xs text-gray-500 mt-2"><i class="fas fa-calendar-alt mr-1"></i>10-11 Dec 2026 &bull; World Trade Center, Mumbai</p>
        </div>
    ...
    async function generateDelegatePass(adminAttendee) {
      ...
      ctx.fillText('10-11 Dec 2026  \u2022  World Trade Center, Mumbai', W/2, curY);
      curY += 24;
      ...
      ctx.textAlign = 'right';
      ctx.fillText('10-11 Dec 2026  \u2022  World Trade Center, Mumbai', panelX + panelW - 28, row2Y);
...
<body class="min-h-screen flex">
  ...
  <script>
    ...
    async function adminDownloadPass(user) {
      ...
      ctx.fillStyle = 'rgba(200,168,85,0.9)'; ctx.font = '500 22px Arial, sans-serif'; ctx.fillText('10-11 Dec 2026', W / 2, 835);
    ...
    async function resendNonResponders() {
      try {
        ...
        const reminderSubject = 'Reminder: Confirm your attendance — Bharat AI Innovation 2026, 10-11 Dec, WTC Mumbai';
        for (const a of result.attendees) {
          try {
      ...
      openModal(\`
        <div style="max-height:80vh;overflow-y:auto;background:#f4f4f5;border-radius:12px;padding:8px;">
          ...
          <div style="background:linear-gradient(135deg,#1a1a2e 0%,#16213e 50%,#0f3460 100%);border-radius:16px;padding:24px 20px;text-align:center;color:white;">
            ...
            <p style="margin:0;opacity:0.8;font-size:13px;">Bharat AI Innovation Conference & Exhibition 2026 &bull; 10-11 Dec 2026</p>
          </div>
          <div style="background:white;border-radius:16px;padding:24px;margin-top:12px;color:#333;">
            ...
            <p style="color:#555;line-height:1.6;font-size:13px;margin:0 0 12px;">
              We are truly grateful for your presence at the <strong style="color:#1a1a2e;">Bharat AI Innovation 2026</strong> ceremony held on <strong style="color:#1a1a2e;">10-11 Dec 2026</strong> at <strong style="color:#1a1a2e;">World Trade Center Mumbai, Mumbai</strong>. Your participation played a vital role in making this event a resounding success.
            </p>
